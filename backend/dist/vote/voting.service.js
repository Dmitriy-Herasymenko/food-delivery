...
let VotingService = exports.VotingService = class VotingService {
    constructor(voteRepository) {
        this.voteRepository = voteRepository;
    }
    async createVote(dto) {
        console.log("dto", dto);
        await this.voteRepository.create(dto);
    }
};
exports.VotingService = VotingService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, sequelize_1.InjectModel)(voting_model_1.Vote)),
